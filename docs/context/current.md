...
1. Завершить `feat/web-booking-composer`: новый green CI → exact-head candidate → ручная проверка быстрого добавления клиентки → merge → production deploy.
...
next=finish PR #167 after inline client creation, then start web client card editing
```
