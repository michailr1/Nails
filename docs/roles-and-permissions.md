...
- создать или привязать собственную минимальную клиентскую карточку;
...
4. найти owner-scoped `client_telegram_identity`;
5. разрешить только публичную client operation;
6. применить одновременно owner и client identity filters;
7. использовать idempotency для мутаций;
8. записать безопасный audit без private contents.
