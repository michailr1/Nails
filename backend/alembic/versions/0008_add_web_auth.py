...
def upgrade() -> None:
    ...
    op.create_index("ix_web_sessions_user_active", "web_sessions", ["user_id", "revoked_at"])
    op.create_index(
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("action", "scope_hash", name="uq_web_auth_rate_bucket_scope"),
    )
    op.create_index(
...
def downgrade() -> None:
    op.drop_index("ix_web_auth_rate_buckets_window", table_name="web_auth_rate_buckets")
    ...
    op.drop_index("ix_web_login_challenges_ip_created", table_name="web_login_challenges")
    op.drop_index("ix_web_login_challenges_status_expires", table_name="web_login_challenges")
