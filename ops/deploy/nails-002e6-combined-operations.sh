...
declare -F verify_built_api_image >/dev/null
declare -F verify_openapi >/dev/null
declare -F build_fresh_api_image >/dev/null
declare -F compose >/dev/null
